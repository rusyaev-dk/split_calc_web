...
import 'package:split_calculator/app/app_context_ext.dart';
...
class _SummaryTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      children: [
        Text(nameFrom, style: textScheme.headline.copyWith(fontSize: 18)),
        Icon(Icons.arrow_right, size: 25, color: colorScheme.onSurface),
        Text(nameTo, style: textScheme.headline.copyWith(fontSize: 18)),
        Spacer(),
        Text(
